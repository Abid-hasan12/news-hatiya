...
export default function Shorts({ shortsData, onSeeAllClick, onNewsClick }) {
      ...
      >
        {shortsData.map((short) => (
          ...
          >
            {/* Thumbnail Image */}
            <img
              src={short.imgSrc || short.image || "https://images.unsplash.com/photo-1611162617213-7d7a39e9b1d7?w=360&q=80"}
              alt={short.title}
